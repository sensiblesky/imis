    ...
    <div class="col-xl-8">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" method="POST" enctype="multipart/form-data" action="{{ route('admin.profile.update') }}" novalidate>
                    @csrf
                    <div class="row">
                        <!-- Firstname -->
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Multi Campuses</label>
                                <!-- Campuses -->
                                <select class="select2 form-control select2-multiple" name="campuses[]" multiple data-placeholder="Choose..." required>
                                    @foreach ($allCampuses as $campus)
                                        <option value="{{ $campus->id }}" {{ in_array($campus->id, $userCampuses) ? 'selected' : '' }}>
                                            {{ $campus->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Multi Workspace</label>
                                <!-- Workspaces -->
                                <select class="select2 form-control select2-multiple" name="workspaces[]" multiple data-placeholder="Choose..." required>
                                    @foreach ($allWorkspaces as $workspace)
                                        <option value="{{ $workspace->id }}" {{ $workspace->id == $user->default_workspace ? 'selected' : '' }}>
                                            {{ $workspace->display_name }}
                                        </option>
