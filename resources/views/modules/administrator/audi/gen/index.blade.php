                                    ...
                                    <tbody>
                                        @forelse($logs as $index => $log)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.logs.gen.view', $log->uid) }}" class="btn btn-primary btn-sm">View</a>
                                                </td>
                                            </tr>
                                        @empty
                            ...
                            <div class="modal fade bs-example-modal-xl" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <form class="needs-validation" method="GET" action="{{ route('admin.logs.gen') }}" novalidate>
                                                <div class="row">
                                                    <div class="col-md-4 mb-3">
                                                        <label class="form-label">Actor Username</label>
                                                        <input type="text" class="form-control" name="actor_username" value="{{ request('username') }}" placeholder="Actor Username">
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <label class="form-label">Victim Username</label>
                                                        <input type="text" class="form-control" name="victim_username" value="{{ request('victim_username') }}" placeholder="Victim Username">
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="model" value="{{ request('model') }}" placeholder="E.g. User, Campus">
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="browser" value="{{ request('browser') }}" placeholder="E.g. Chrome, Firefox">
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <label class="form-label">Platform</label>
                                                        <input type="text" class="form-control" name="platform" value="{{ request('platform') }}" placeholder="E.g. Windows, macOS">
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <a href="{{ route('admin.logs.gen') }}" class="btn btn-secondary">Reset</a>
                                                </div>
                                            </form>
