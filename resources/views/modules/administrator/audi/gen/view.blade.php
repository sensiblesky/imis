...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Change Logs</h5>
                    @php
                                ...
                                <tbody>
                                    @foreach ($changes as $change)
                                        <tr>
                                            ...
                                            <td>{!! is_array($change['old']) ? '<pre>' . json_encode($change['old'], JSON_PRETTY_PRINT) . '</pre>' : e($change['old'] ?? 'null') !!}</td>
                                            <td>{!! is_array($change['new']) ? '<pre>' . json_encode($change['new'], JSON_PRETTY_PRINT) . '</pre>' : e($change['new'] ?? 'null') !!}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    @else
                        <div class="text-muted">No changes detected.</div>
                    @endif
                </div>
            </div>
