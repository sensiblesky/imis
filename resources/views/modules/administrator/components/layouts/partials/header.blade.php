        ...
        <div class="d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('admin.notifications.index') }}" class="small" key="t-view-all">View All</a>
                            </div>
                        </div>
                    </div>
                    <div data-simplebar style="max-height: 230px;">
                        @foreach ($header_notifications as $notification)
                        <a href="{{ route('admin.notifications.view', $notification->uid) }}" class="text-reset notification-item">
                            <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item d-block" href="{{ route('admin.system') }}"><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings">Settings</span></a>
