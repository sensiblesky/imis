    ...
    <div class="row mb-4">
        <div class="col-lg-12">
            <div class="d-flex align-items-center">
                ...
                <div>
                <a href="{{ route('admin.users.staff.create') }}" class="btn btn-danger waves-effect waves-light me-2">
                                    ...
                                    <tbody>
                                        @foreach ($staffUsers as $index => $staff)
                                            <tr>
                                                ...
                                                <td>
                                                <a href="{{ route('admin.users.staff.view', $staff->staff_uid) }}" class="btn btn-primary waves-effect waves-light">
                                                    View
                                                </a>
                                                <form action="{{ route('admin.users.staff.destroy', $staff->staff_uid) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="needs-validation" method="GET" action="{{ route('admin.users.staff') }}" novalidate>
                                                    <div class="row">
                                                    ...
                                                    <div>
                                                        ...
                                                        <a href="{{ route('admin.users.staff') }}" class="btn btn-secondary">Reset</a>
                                                    </div>
                                                </form>
