                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="pt-4">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('admin.users.student.edit', $student->uid) }}" class="btn btn-primary waves-effect waves-light btn-sm">Edit Profile <i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="datatable2" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        @forelse($sessions as $index => $session)
                            <tr>
                                ...
                                <td>
                                <form method="POST" action="{{ route('admin.users.student.terminateSession', $student->uid) }}" style="display:inline" class="terminate-form">
                                    @csrf
                                    @method('DELETE')
