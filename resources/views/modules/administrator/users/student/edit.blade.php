                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="pt-4">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('admin.users.student.view', $student->uid) }}" class="btn btn-primary waves-effect waves-light btn-sm"> <i class="mdi mdi-arrow-left ms-1"></i> Back Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.users.student.update', $student->uid) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
