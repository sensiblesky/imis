                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="pt-4">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('support.profile.edit') }}" class="btn btn-primary waves-effect waves-light btn-sm">Edit Profile <i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!$session['current_session'])
                                        <form method="POST" action="{{ route('support.profile.terminateSession') }}" style="display:inline" class="terminate-form">
                                            @csrf
                                            @method('DELETE')
