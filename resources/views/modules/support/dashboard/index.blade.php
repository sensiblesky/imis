                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <p class="text-muted mb-0 text-truncate">System Support</p>
                        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <form class="row row-cols-lg-auto g-3 align-items-center" method="GET" action="{{ route('session.academic-year.update') }}">
                        <div class="col-12">
                ...
                <div class="col-lg-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <p class="text-muted fw-medium">Issued ID</p>
                                    <h4 class="mb-0">{{ number_format($issuedID) }}</h4>
                                </div>
                        ...
                        <div class="card-body border-top py-3">
                            <a href="{{ route('support.users.staff') }}" class="btn btn-outline-primary btn-sm">View All Users</a>
                        </div>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-lg-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <p class="text-muted fw-medium">Pending ID</p>
                                    <h4 class="mb-0">{{ number_format($pendingIssueID) }}</h4>
                                </div>
                                <div class="flex-shrink-0 align-self-center">
                                    <div class="mini-stat-icon avatar-sm rounded-circle bg-primary">
                                        <span class="avatar-title">
                                            <i class="mdi mdi-credit-card-clock-outline font-size-24"></i>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body border-top py-3">
                            <a href="{{ route('support.users.students') }}" class="btn btn-outline-success btn-sm">View Students</a>
                        </div>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-lg-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <p class="text-muted fw-medium">Total Renewed</p>
                                    <h4 class="mb-0">{{ number_format($totalStudentIdReplacements) }}</h4>
                                </div>
                                <div class="flex-shrink-0 align-self-center">
                                    <div class="mini-stat-icon avatar-sm rounded-circle bg-primary">
                                        <span class="avatar-title">
                                            <i class="mdi mdi-credit-card-multiple-outline font-size-24"></i>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body border-top py-3">
                            <a href="{{ route('support.users.staff') }}" class="btn btn-outline-info btn-sm">View Staff</a>
                        </div>
                    </div>
                </div><!--end col-->
            </div>
