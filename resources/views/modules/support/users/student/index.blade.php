    ...
    <div class="row mb-4">
        <div class="col-lg-12">
            <div class="d-flex align-items-center">
                ...
                <div>
                <a href="{{ route('support.users.student.create') }}" class="btn btn-danger waves-effect waves-light me-2">
                                    ...
                                    <tbody>
                                        @foreach ($studentUsers as $index => $student)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('support.users.student.view', $student->uid) }}" class="btn btn-primary btn-sm">
                                                        View
                                                    </a>
                                                    <form action="{{ route('support.users.student.destroy', $student->uid) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                            ...
                            <div class="modal fade bs-example-modal-xl" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <form class="needs-validation" method="GET" action="{{ route('support.users.students') }}" novalidate>
                                                <div class="row">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="{{ route('support.users.students') }}" class="btn btn-secondary">Reset</a>
                                                </div>
                                            </form>
