                ...
                <div class="w-100">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-xl-9 col-sm-6">
                                        <div class="mt-4 mt-sm-0 float-sm-end d-flex align-items-center">
                                            <a href="{{ route('support.users.staff') }}" class="btn btn-primary btn-sm me-2"><i class="ri-arrow-left-line"></i> Back to Staff Users</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <form action="{{ route('support.users.staff.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    @csrf
