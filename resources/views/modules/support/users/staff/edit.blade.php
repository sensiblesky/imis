                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="pt-4">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('support.users.staff.view', $staff->uid) }}" class="btn btn-primary waves-effect waves-light btn-sm"> <i class="mdi mdi-arrow-left ms-1"></i> Back Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('support.users.staff.update', $staff->uid) }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-md-1">
                    ...
                    <div>
                                                            <p class="text-danger">This support portal is restricted to perform administrative tasks. if you need to create administrative account please contact with your system admin to obtain permission</p>
