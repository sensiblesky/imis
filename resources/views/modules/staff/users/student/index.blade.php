                                    ...
                                    <tbody>
                                        @foreach ($studentUsers as $index => $student)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('staff.users.student.view', $student->uid) }}" class="btn btn-primary btn-sm">
                                                        View
                                                    </a>
                                                </td>
                                            </tr>
                            ...
                            <div class="modal fade bs-example-modal-xl" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <form class="needs-validation" method="GET" action="{{ route('staff.users.students') }}" novalidate>
                                                <div class="row">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="{{ route('staff.users.students') }}" class="btn btn-secondary">Reset</a>
                                                </div>
                                            </form>
