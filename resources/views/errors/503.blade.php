...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>503 | Under Maintainance</title>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="home-wrapper">
                            ...
                            <h3 class="mt-5">System is Under Maintenance</h3>
                                ...
                                <div class="col-md-4">
                                    <div class="card mt-4 maintenance-box">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted mb-0">We're currently performing scheduled maintenance to improve your experience. We'll be back online shortly..</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mt-4 maintenance-box">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted mb-0">The downtime is temporary and typically lasts no more than a 1 hour. We appreciate your patience..</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mt-4 maintenance-box">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted mb-0">If you have any questions or need assistance, feel free to contact us at support</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
