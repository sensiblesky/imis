...
class ProfileController extends Controller
{
    ...
    public function show()
    {
        ...
        return view('modules.staff.profile.index', compact('user', 'campuses', 'loginLogs', 'sessions'));
    }
    ...
    public function edit()
    {
        ...
        return view('modules.staff.profile.edit', compact('user', 'userCampuses', 'campuses', 'allCampuses', 'loginLogs', 'allWorkspaces'));
    }
