...
namespace App\Http\Controllers\Modules\staff\Users\Student;
    ...
    public function StudentIndex(Request $request)
{
    ...
    return view('modules.staff.users.student.index', compact(
        'studentUsers',
        'campuses',
        'programs',
        'levels',
    ...
    public function StudentView($uid)
    {
       ...
       $qrCodeUrl = 'http://196.41.62.121/verify/student/' . $uid;
        ...
        return view('modules.staff.users.student.view', compact('student', 'campuses', 'loginLogs', 'sessions', 'GeneralLogs', 'barcodeDataUri', 'qrCodeDataUri', 'otherFeeAmount', 'allRequests' ));
    }
...
public function approveOrReject(Request $request, $id)
{
    ...
    public function StudentCreate()
    {
        ...
        return view('modules.staff.users.student.create', compact(
            'titles',
            'level',
            'programs',
            'academicYears',
    ...
    public function Studentedit($uid)
{
    ...
    return view('modules.staff.users.student.edit', compact(
        'student',
        'disabilities',
        'studentDisabilities',
        'allCampuses',
