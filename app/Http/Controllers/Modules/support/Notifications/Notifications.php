...
namespace App\Http\Controllers\Modules\support\Notifications;
...
class Notifications extends Controller
{
    public function getNotifications(Request $request)
    {
        ...
        return view('modules.support.notifications.index', compact('notifications', 'campuses', 'workspaces'));
    }
    ...
    public function viewNotification(Request $request, $uid)
{
    ...
    return view('modules.support.notifications.view', [
