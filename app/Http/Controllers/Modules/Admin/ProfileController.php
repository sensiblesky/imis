...
class ProfileController extends Controller
{
    public function show()
    {
        ...
        return view('modules.administrator.profile.index', compact('user', 'campuses', 'loginLogs', 'sessions'));
    }
    ...
    public function edit()
    {
        ...
        return view('modules.administrator.profile.edit', compact('user', 'userCampuses', 'campuses', 'allCampuses', 'loginLogs', 'allWorkspaces'));
    }
    ...
    public function update(Request $request)
    {
        ...
        // Sync campuses
        DB::table('user_campuses')->where('user_id', $userId)->delete();

        if ($request->has('campuses')) {
            foreach ($request->campuses as $campusId) {
        ...
        // Sync workspaces
        DB::table('user_workspaces')->where('user_id', $userId)->delete();

        if ($request->has('workspaces')) {
            foreach ($request->workspaces as $workspaceId) {
