...
namespace App\Http\Controllers\Modules\Admin\Notifications;
...
class Notifications extends Controller
{
    public function getNotifications(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // Create notification
            try {
                $notification = DB::table('messages_notifications')->insertGetId([
                    'uid' => Str::uuid(),
                    'title' => $request->input('title'),
                    'message' => $request->input('message'),
                    'type' => 'custom', // or use any logic to determine type
                    'created_at' => now(),
                    'updated_at' => now(),
                ]);

                // Attach campuses and workspaces to notification
                foreach ($request->input('campuses') as $campusId) {
                    DB::table('messages_notifications_campus')->insert([
                ...
                foreach ($request->input('workspaces') as $workspaceId) {
                    DB::table('messages_notifications_workspace')->insert([
                        'notification_id' => $notification,
        ...
        return view('modules.administrator.notifications.index', compact('notifications', 'campuses', 'workspaces'));
    }
    ...
    public function viewNotification(Request $request, $uid)
{
    ...
    return view('modules.administrator.notifications.view', [
